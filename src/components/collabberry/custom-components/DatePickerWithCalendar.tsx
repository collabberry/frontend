...
import useMergedRef from "../../ui/hooks/useMergeRef";
...
import type { CalendarSharedProps } from "../../ui/DatePicker/CalendarBase";
import type { BasePickerSharedProps } from "../../ui/DatePicker/BasePicker";
...
const DatePickerWithCalendar = forwardRef<HTMLInputElement, DatePickerWithCalendarProps>(
  (props, ref) => {
    const {
      className,
      clearable = true,
