...
const Assessment = () => {
  ...
  const getOrganizationById = async () => {
    try {
      ...
      console.log("Org retrieved successfully:", response);
    } catch (error) {
  ...
  const editOrganization = async () => {
    try {
      ...
      console.log("Org updated successfully:", response);
    } catch (error) {
  ...
  const getInvitationToken = async (email: string) => {
    try {
      ...
      console.log("Invitation token retrieved successfully:", response);
    } catch (error) {
  ...
  const getContributorAgreement = async () => {
    ...
    try {
      ...
      console.log("Contributor agreement retrieved successfully:", response);
    } catch (error) {
